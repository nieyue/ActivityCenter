...
public class DataServiceImpl implements DataService{
	...
	public Data loadData(Integer dataId,Date createDate,Integer activityId,Integer acountId) {
		Data r = dataDao.loadData(dataId,createDate,activityId,acountId);
		return r;
	}

	@Override
	public int countAll(Date createDate,Integer activityId,Integer acountId) {
		int c = dataDao.countAll(createDate,activityId,acountId);
		return c;
	}

	@Override
	public List<Data> browsePagingData(Date createDate,Integer activityId,Integer acountId,int pageNum, int pageSize,
		...
		List<Data> l = dataDao.browsePagingData(createDate,activityId,acountId,pageNum-1, pageSize, orderName, orderWay);
		return l;
	}
	@Override
	...
	@Override
	public List<Data> statisticsData(Date startDate, Date endDate, Integer activityId, Integer acountId, int pageNum,
		...
		List<Data> l = dataDao.statisticsData(startDate,endDate,activityId,acountId,pageNum-1, pageSize, orderName, orderWay);
		return l;
	}
