...
public class DailyDataServiceImpl implements DailyDataService{
	...
	@Override
	public DailyData loadDailyData(Integer dailyDataId,Date createDate,Integer activityId,Integer acountId) {
		DailyData r = dailyDataDao.loadDailyData(dailyDataId,createDate,activityId,acountId);
		return r;
	}

	@Override
	public int countAll(Date createDate,Integer activityId,Integer acountId) {
		int c = dailyDataDao.countAll(createDate,activityId,acountId);
		return c;
	}

	@Override
	public List<DailyData> browsePagingDailyData(Date createDate,Integer activityId,Integer acountId,int pageNum, int pageSize,
		...
		List<DailyData> l = dailyDataDao.browsePagingDailyData(createDate,activityId,acountId,pageNum-1, pageSize, orderName, orderWay);
		return l;
	}
	@Override
	...
	@Override
	public List<DailyData> statisticsDailyData(Date startDate,Date endDate, Integer activityId,Integer acountId, int pageNum, int pageSize,
			String orderName, String orderWay) {
		if(pageNum<1){
			pageNum=1;
		}
		...
		List<DailyData> l = dailyDataDao.statisticsDailyData(startDate,endDate, activityId, acountId, pageNum-1, pageSize, orderName, orderWay);
		return l;
	}
